!function () {
    ...
    var H = function (o) {
        ...
        return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.getCurrentPath = function () {
            ...
            void 0 === i && (i = d), p("click", function (e) {
                ...
                n && "A" === n.tagName && !/_blank/.test(n.target) && (e.preventDefault(), n = n.href, -1 !== o.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({key: n}, "", n), i({
                    event: e,
                    source: "navigate"
                }))
    ...
    var Ee = /(^|[^\[])\^/g;
    var Te = /[^\w:]/g, Ce = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;
    var Re = {}, je = /^[^:]+:\/*[^/]*$/, Oe = /^([^:]+:)[\s\S]*$/, Le = /^([^:]+:\/*[^/]*)[\s\S]*$/;
    ...
    var qn, Pn = be(function (e) {
        var u, f, p, d, n, g = function (u) {
            var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, n = 0, e = {}, T = {
                ...
                highlightElement: function (e, n, i) {
                    var o = T.util.getLanguage(e), t = T.languages[o];
    ...
    In.prototype.compileEmbed = function (e, n) {
        ...
        return t.heading = e.heading = function (e, n) {
            var i = On(e), o = i.str, t = i.config, e = {level: n, title: Ln(o)};
            ...
            var o = [], t = On(n = void 0 === n ? "" : n), a = t.str, t = t.config;
            ...
            var o = e, t = [], a = On(n), r = a.str, a = a.config;
